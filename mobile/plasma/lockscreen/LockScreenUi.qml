...
Item {
    ...
    MouseArea {
        ...
        DropShadow {
            ...
            anchors.fill: clock
            source: clock
            visible: false // HELM Security Lock v2 clock lives in HELMOverlay
            radius: 7
            verticalOffset: 0.8
            samples: 15
            spread: 0.2
        ...
        StackView {
            ...
            initialItem: MainBlock {
                ...
                showUserList: false // HELM Security Lock v2 identifies the operator in its own frame
                ...
                actionItems: [
                    ActionButton {
                        ...
                        visible: false // HELM Security Lock v2.1: action hidden for clean lock UI
                    },
                    ActionButton {
        ...
        RowLayout {
            id: footer
            visible: false // HELM Security Lock v2.1 footer is intentionally hidden
            anchors {
                bottom: parent.bottom
                left: parent.left
                right: parent.right
