...
class AIScreen(Vertical):
    ...
    def display_system_report(
        ...
        """Display a report generated by another HELM service."""
        clean_title = title.strip() or "HELM SYSTEM REPORT"
        clean_report = report.strip() or "No report data."
        ...
        self.query_one(
            ...
            "[b cyan]"
            f"{escape(clean_title)}"
            "[/b cyan]\n"
            f"{escape(clean_report)}"
        )
