...
Item {
    ...
    Rectangle {
        ...
        width: Math.min(470, root.width * 0.36)
        height: 126
        ...
        Column {
            ...
            Text {
                text: "ACCESS GATE  //  CYBERDECK OS 1.0"
                color: "#D9F3FF"
            ...
            Text {
                text: "● AUTHENTICATION NODE READY"
                color: "#58F6D0"
            ...
            Text {
                text: "OPERATOR DARIUSZ  //  LOCAL ACCESS"
                color: "#6F9DA8"
    ...
    MouseArea {
        ...
        QQC2.StackView {
            ...
            initialItem: Login {
                ...
                actionItems: [
                    ActionButton {
                        icon.name: "/usr/share/sddm/themes/Graphite/assets/suspend_primary.svg"
                    ...
                    ActionButton {
                        icon.name: "/usr/share/sddm/themes/Graphite/assets/restart_primary.svg"
                    ...
                    ActionButton {
                        icon.name: "/usr/share/sddm/themes/Graphite/assets/shutdown_primary.svg"
                    ...
                    ActionButton {
                        icon.name: "/usr/share/sddm/themes/Graphite/assets/switch_primary.svg"
